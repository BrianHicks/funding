...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.video'
        db.add_column('trips_trip', 'video',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.video'
        db.delete_column('trips_trip', 'video')
    ...
    models = {
        ...
        'trips.trip': {
            ...
            'video': ('django.db.models.fields.CharField', [], {'max_length': '140', 'blank': 'True'}),
